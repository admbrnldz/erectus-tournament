 <footer>
    <div class="container">
  		<div class="row">
  			<p class="text-center">For support and information</p>
  		</div>
      <div class="row">
      	...
      	<div class="col-md-4 text-center">
      		<p>or visit our official website: </p>
      		<P>
      			<a href="http://maatagames.com/" id="maata-link" target="_blank">Maata Games Official Website</a>
      		</p>
      	</div>
      </div>
      <div class="row">
        <p class="text-center">&copy; Maata Games, Inc., 2016</p>
      </div>
    </div>
 </footer>